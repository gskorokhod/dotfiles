...
Config.instname = "University of St Andrews"
Config.profilename = "eduroam"
Config.url = "https://www.st-andrews.ac.uk/it-support/"
Config.email = "itservicedesk@st-andrews.ac.uk"
Config.title = "eduroam CAT"
Config.server_match = "dot1x.st-andrews.ac.uk"
...
Config.user_realm = "st-andrews.ac.uk"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:dot1x.st-andrews.ac.uk']
Config.use_other_tls_id = False
Config.anonymous_identity = "@st-andrews.ac.uk"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
