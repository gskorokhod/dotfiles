...
[ -f "/home/mayday/.ghcup/env" ] && source "/home/mayday/.ghcup/env" # ghcup-env
[ -f "/home/mayday/.cargo/env" ] && source "/home/mayday/.cargo/env" # cargo-env
[ -f "/home/mayday/.cabal/bin/ghc-env" ] && source "/home/mayday/.cabal/bin/ghc-env" # ghc-env
...
# pnpm
export PNPM_HOME="/home/mayday/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
